...
Azure::Keyvault::Keys provides shared primitives, abstractions, and helpers for modern Azure SDK Key Vault Keys client library written in the C++. These library follow the [Azure SDK Design Guidelines for C++][azure_sdk_cpp_development_guidelines].
